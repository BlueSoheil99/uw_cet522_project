...
# lines below should be changed based on OS (mac or windows)
GLOB_ADDRESS = './data/DriveNet/*/*.xlsx'
SPLITTER = '/'
...
def _create_meta(glob_address=GLOB_ADDRESS):
    ...
    for name in file_names:
        ...
        info['start_date'].append(datetime.strptime(start, '%Y-%m-%d').date())
        info['end_date'].append(datetime.strptime(end, '%Y-%m-%d').date())
